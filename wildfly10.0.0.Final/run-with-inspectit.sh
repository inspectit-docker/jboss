...
CONFIG_FILE=/opt/jboss/wildfly/bin/standalone.conf

sed -i -- "s/_CMR_ADDRESS_/$CMR_ADDR/g" $CONFIG_FILE
sed -i -- "s/_CMR_PORT_/$CMR_PORT/g" $CONFIG_FILE
sed -i -- "s/_AGENT_NAME_/$AGENT_NAME/g" $CONFIG_FILE
